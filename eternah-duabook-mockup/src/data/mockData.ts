// Define the shape of our Dua object
export interface Dua {
  id: string;
  category: string; // e.g., 'Anxiety', 'Morning', 'Forgiveness'
  arabic: string;
...
export const mockDuas: Dua[] = [
  {
    id: '1',
    category: 'Anxiety',
    // Prophet Musa (AS) asking for confidence and ease
